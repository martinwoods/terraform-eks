...
resource "aws_route" "private_01_to_ix_it_ops_vpn_vlan_245" {
  route_table_id         = var.eks_private_route_table_01_id
  destination_cidr_block = local.ch_dev_vm_vlan_245
  transit_gateway_id     = var.eks_transit_gateway_id
}

resource "aws_route" "private_02_to_ix_it_ops_vpn_vlan_245" {
  route_table_id         = var.eks_private_route_table_02_id
  destination_cidr_block = local.ch_dev_vm_vlan_245
  transit_gateway_id     = var.eks_transit_gateway_id
}

resource "aws_route" "private_03_to_ix_it_ops_vpn_vlan_245" {
  route_table_id         = var.eks_private_route_table_03_id
  destination_cidr_block = local.ch_dev_vm_vlan_245
  transit_gateway_id     = var.eks_transit_gateway_id
}
